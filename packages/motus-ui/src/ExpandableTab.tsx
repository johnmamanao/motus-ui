...
import { ArrowUpRight, AudioLines, BookOpen, Compass, Mail, MousePointer2, Orbit, Sparkles } from 'lucide-react';
  ...
  return (
    <div className="p-3 text-zinc-950">
      ...
      <div className="mt-2 flex gap-2">
        <button className="flex-1 rounded-xl bg-[#f4f2ff] px-3 py-2 text-left text-xs font-medium text-[#5b49c8]">
          Process
        </button>
        <button className="flex-1 rounded-xl bg-[#fff1e9] px-3 py-2 text-left text-xs font-medium text-[#a94f22]">
          Notes
        </button>
      </div>
    </div>
