...
const keyframe = (time: number, start: number[], end: number[]) => ({
  t: time,
  s: start,
  e: end,
  i: easeIn,
...
function shapeLayer(
  ...
  return {
    ...
    ao: 0,
    shapes: roundedShape(size, radius),
    ip: 0,
    op: 120,
    st: 0,
    bm: 0,
  ...
  return {
    ...
    ks: {
      ...
      s: {
        a: 1,
        k: [
          keyframe(delay, [92, 92, 100], [104, 104, 100]),
          keyframe(45 + delay, [104, 104, 100], [92, 92, 100]),
          { t: 90, s: [92, 92, 100] },
        ],
      },
    },
...
export const motusMarkAnimation = {
  ...
  ddd: 0,
  assets: [],
  layers: [diamondLayer(1, [60, 60], 100, 0), diamondLayer(2, [75, 51], 58, 5), diamondLayer(3, [48, 74], 30, 10)],
};
...
const focusRing = (index: number, size: number, delay: number, opacity: number) => ({
  ...
  ks: {
    ...
    s: {
      a: 1,
      k: [
        keyframe(delay, [78, 78, 100], [104, 104, 100]),
        keyframe(44 + delay, [104, 104, 100], [78, 78, 100]),
        { t: 100, s: [78, 78, 100] },
      ],
    },
  },
  ...
  layers: [
    {
      ...
      shapes: [
        { ty: 'el', d: 1, s: { a: 0, k: [26, 26] }, p: { a: 0, k: [0, 0] }, nm: 'Ball' },
        ...roundedShape([1, 1], 0).slice(1),
      ],
      ks: {
        o: { a: 0, k: 100 },
        r: { a: 0, k: 0 },
        p: {
          a: 1,
          k: [
            keyframe(0, [60, 24, 0], [60, 88, 0]),
            keyframe(32, [60, 88, 0], [60, 52, 0]),
            keyframe(56, [60, 52, 0], [60, 88, 0]),
            keyframe(76, [60, 88, 0], [60, 72, 0]),
            { t: 108, s: [60, 88, 0] },
          ],
        },
        a: { a: 0, k: [0, 0, 0] },
        s: {
          ...
          k: [
            ...
            keyframe(30, [100, 100, 100], [128, 72, 100]),
            keyframe(40, [128, 72, 100], [94, 106, 100]),
            { t: 108, s: [100, 100, 100] },
          ],
        },
      },
...
const sourceLine = (index: number, y: number, width: number, delay: number, opacity: number) => ({
  ...
  ks: {
    ...
    s: {
      a: 1,
      k: [
        keyframe(delay, [0, 100, 100], [108, 100, 100]),
        keyframe(35 + delay, [108, 100, 100], [100, 100, 100]),
        { t: 100, s: [100, 100, 100] },
      ],
    },
  },
...
const principleAnimations = {
  focus: {
    ...
    ddd: 0,
    assets: [],
    layers: [focusRing(3, 86, 8, 32), focusRing(2, 58, 4, 58), focusRing(1, 28, 0, 100)],
  },
  ...
  source: {
    ...
    ddd: 0,
    assets: [],
    layers: [sourceLine(3, 82, 70, 16, 36), sourceLine(2, 59, 90, 8, 62), sourceLine(1, 36, 62, 0, 100)],
  },
};
...
const successBar = (
  ...
  ks: {
    ...
    s: {
      a: 1,
      k: [
        keyframe(start, [0, 100, 100], [112, 100, 100]),
        keyframe(start + 12, [112, 100, 100], [100, 100, 100]),
        { t: start + 20, s: [100, 100, 100] },
      ],
    },
  },
  ao: 0,
...
export const successAnimation = {
  ...
  ddd: 0,
  assets: [],
  layers: [successBar(1, [26, 9], [38, 54], 42, 4), successBar(2, [45, 9], [59, 45], -43, 10)],
};

export function MotusMotionMark({
  className = '',
  tone = 'light',
  loop = false,
}: {
  ...
  return (
    <span
      className={`lottie-mark ${tone === 'light' ? 'lottie-tone-light' : 'lottie-tone-dark'} ${className}`}
      aria-hidden="true"
      onPointerEnter={() => {
        player.current?.stop();
        player.current?.play();
...
export function SpringSignal({
  ...
  return (
    <span
      className={`lottie-spring ${tone === 'light' ? 'lottie-tone-light' : 'lottie-tone-dark'} ${className}`}
      aria-hidden="true"
    >
      <LottieLight src={springSignalAnimation} autoplay={!reduced} loop={loop && !reduced} speed={0.78} />
    </span>
  );
}
...
export function PrincipleMotion({
  ...
  kind: keyof typeof principleAnimations;
  tone?: 'light' | 'dark';
  className?: string;
}) {
  const reduced = useReducedMotion();
  return (
    <span
      className={`lottie-principle ${tone === 'light' ? 'lottie-tone-light' : 'lottie-tone-dark'} ${className}`}
      aria-hidden="true"
    >
      <LottieLight src={principleAnimations[kind]} autoplay={!reduced} loop={!reduced} speed={0.72} />
    </span>
  );
}
...
export function MotionCheck({ className = '', tone = 'light' }: { className?: string; tone?: 'light' | 'dark' }) {
  ...
  return (
    <LottieLight
      ...
      autoplay={!reduced}
      loop={false}
      className={`lottie-check ${tone === 'light' ? 'lottie-tone-light' : 'lottie-tone-dark'} ${className}`}
      aria-hidden="true"
    />
  );
}
...
export function MotionReset({ playKey }: { playKey: number }) {
  ...
  return (
    <LottieLight
      ...
      loop={false}
      speed={1.8}
      className="lottie-reset lottie-tone-light"
      aria-hidden="true"
    />
  );
}
...
const animatedCircle = (
  ...
  ks: {
    o: { a: 0, k: opacity },
    r: { a: 0, k: 0 },
    p: typeof positionFrames[0] === 'object' ? { a: 1, k: positionFrames } : { a: 0, k: positionFrames },
    a: { a: 0, k: [0, 0, 0] },
    s: scaleFrames ? { a: 1, k: scaleFrames } : { a: 0, k: [100, 100, 100] },
  },
  ao: 0,
  shapes: circleShape(size),
  ip: 0,
  op: 96,
  st: 0,
  bm: 0,
...
const shiftingFrame = (
  ...
  ao: 0,
  shapes: roundedShape([48, 68], 16, 3, false),
  ip: 0,
  op: 240,
  st: 0,
  bm: 0,
...
const heroFrameShiftAnimation = {
  ...
  layers: [
    shiftingFrame(
      ...
      [keyframe(0, [-8], [0]), keyframe(80, [0], [-11]), keyframe(160, [-11], [-8]), { t: 240, s: [-8] }],
      100,
    ),
    shiftingFrame(
      3,
    ...
    ),
    {
      ...
      ks: {
        ...
        s: {
          a: 1,
          k: [
            keyframe(0, [82, 82, 100], [118, 76, 100]),
            keyframe(80, [118, 76, 100], [76, 118, 100]),
            keyframe(160, [76, 118, 100], [82, 82, 100]),
            { t: 240, s: [82, 82, 100] },
          ],
        },
      },
    ...
    },
    {
      ...
      ks: {
        o: {
          a: 1,
          k: [keyframe(0, [18], [48]), keyframe(80, [48], [18]), keyframe(160, [18], [18]), { t: 240, s: [18] }],
        },
        r: { a: 0, k: 0 },
        p: { a: 0, k: [80, 105, 0] },
        a: { a: 0, k: [0, 0, 0] },
        s: {
          a: 1,
          k: [
            keyframe(0, [55, 100, 100], [100, 100, 100]),
            keyframe(80, [100, 100, 100], [55, 100, 100]),
            keyframe(160, [55, 100, 100], [55, 100, 100]),
            { t: 240, s: [55, 100, 100] },
          ],
        },
      },
...
export function HeroMotionIcon({ tone = 'dark', className = '' }: { tone?: 'light' | 'dark'; className?: string }) {
  ...
  return (
    <span
      className={`landing-motion-icon hero-motion-icon ${tone === 'light' ? 'lottie-tone-light' : 'lottie-tone-dark'} ${className}`}
      aria-hidden="true"
    >
      <LottieLight src={heroFrameShiftAnimation} autoplay={!reduced} loop={!reduced} speed={0.78} />
    </span>
  );
}
...
const previewIconAnimation = {
  ...
  layers: [
    animatedCircle(
      3,
      'Preview point',
      [keyframe(0, [40, 60, 0], [78, 60, 0]), keyframe(34, [78, 60, 0], [60, 60, 0]), { t: 76, s: [60, 60, 0] }],
      16,
      [
        keyframe(0, [72, 72, 100], [112, 112, 100]),
        keyframe(38, [112, 112, 100], [100, 100, 100]),
        { t: 76, s: [100, 100, 100] },
      ],
    ),
    {
      ...
      ks: {
        ...
        s: {
          a: 1,
          k: [
            keyframe(0, [84, 84, 100], [103, 103, 100]),
            keyframe(34, [103, 103, 100], [100, 100, 100]),
            { t: 76, s: [100, 100, 100] },
          ],
        },
      },
    ...
    animatedCircle(
      ...
      44,
      [
        keyframe(18, [45, 45, 100], [112, 112, 100]),
        keyframe(52, [112, 112, 100], [100, 100, 100]),
        { t: 76, s: [100, 100, 100] },
      ],
      15,
    ),
...
const pressIconAnimation = {
  ...
  assets: [],
  layers: [
    animatedCircle(3, 'Press center', [60, 60, 0], 34, [
      keyframe(0, [100, 100, 100], [74, 74, 100]),
      keyframe(22, [74, 74, 100], [106, 106, 100]),
      keyframe(43, [106, 106, 100], [100, 100, 100]),
      { t: 76, s: [100, 100, 100] },
    ]),
    {
      ...
      ks: {
        o: { a: 1, k: [keyframe(0, [18], [58]), keyframe(28, [58], [18]), { t: 76, s: [18] }] },
        r: { a: 0, k: 0 },
        p: { a: 0, k: [60, 60, 0] },
        a: { a: 0, k: [0, 0, 0] },
        s: {
          a: 1,
          k: [
            keyframe(0, [72, 72, 100], [108, 108, 100]),
            keyframe(38, [108, 108, 100], [100, 100, 100]),
            { t: 76, s: [100, 100, 100] },
          ],
        },
      },
  ...
  layers: [
    {
      ...
      ks: {
        ...
        p: {
          a: 1,
          k: [keyframe(0, [61, 59, 0], [70, 68, 0]), keyframe(35, [70, 68, 0], [67, 65, 0]), { t: 76, s: [67, 65, 0] }],
        },
        a: { a: 0, k: [0, 0, 0] },
        s: { a: 0, k: [100, 100, 100] },
      },
    ...
    },
    {
      ...
      ks: {
        ...
        p: {
          a: 1,
          k: [keyframe(0, [58, 56, 0], [48, 46, 0]), keyframe(35, [48, 46, 0], [51, 49, 0]), { t: 76, s: [51, 49, 0] }],
        },
        a: { a: 0, k: [0, 0, 0] },
        s: { a: 0, k: [100, 100, 100] },
      },
    ...
    animatedBar(
      ...
      [24, 5],
      [
        keyframe(24, [0, 100, 100], [108, 100, 100]),
        keyframe(45, [108, 100, 100], [100, 100, 100]),
        { t: 76, s: [100, 100, 100] },
      ],
      100,
    ),
...
const tuneIconAnimation = {
  ...
  layers: [
    animatedCircle(
      6,
      'Top control',
      [keyframe(0, [42, 36, 0], [78, 36, 0]), keyframe(38, [78, 36, 0], [68, 36, 0]), { t: 76, s: [68, 36, 0] }],
      14,
    ),
    animatedCircle(
      5,
      'Middle control',
      [keyframe(6, [78, 60, 0], [42, 60, 0]), keyframe(44, [42, 60, 0], [52, 60, 0]), { t: 76, s: [52, 60, 0] }],
      14,
    ),
    animatedCircle(
      4,
      'Bottom control',
      [keyframe(12, [50, 84, 0], [72, 84, 0]), keyframe(50, [72, 84, 0], [64, 84, 0]), { t: 76, s: [64, 84, 0] }],
      14,
    ),
...
export function LandingMotionIcon({
  kind,
  tone = 'light',
  className = '',
}: {
  kind: LandingMotionIconKind;
  tone?: 'light' | 'dark';
  className?: string;
}) {
  ...
  return (
    <span
      ref={host}
      className={`landing-motion-icon ${tone === 'light' ? 'lottie-tone-light' : 'lottie-tone-dark'} ${className}`}
      aria-hidden="true"
      onPointerEnter={replay}
    >
      <LottieLight lottieRef={player} src={landingIconAnimations[kind]} autoplay={false} loop={false} speed={0.86} />
    </span>
  );
}
